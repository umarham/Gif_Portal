            ...
            {gifList.map((item, index) => (
              <div className="gif-item" key={index}>
                ...
                <div className="vote">
                  ...
                  <button className="vote-button vote-up-button" onClick={upVote} value={index}>👍</button>
                  <button className="vote-button vote-down-button" onClick={downVote} value={index}>👎</button>
                </div>
              </div>
            ))}
          </div>
    ...
    <div className="App">
      <div className="container">
        <div className="header-container">
          <p className="header"> 🧑🏾‍🎤  ANIMES Gif Portal 👨‍🎤</p>
          <p className="sub-text">
            View your Animes collection in the metaverse ✨✨
          </p>
